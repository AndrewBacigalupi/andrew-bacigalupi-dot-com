        ...
        <div className="space-y-8">
          {sortedPosts.map((post) => (
            <Link 
              ...
              className="block border-b border-gray-300 pb-8 hover:opacity-80 transition-opacity"
            >
              <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-2">
                <h2 className="text-3xl font-bold tracking-tight flex-1" style={{ fontFamily: 'Georgia, serif' }}>
                  {post.title}
                </h2>
                <span className="text-sm text-gray-600 font-normal whitespace-nowrap flex-shrink-0" style={{ fontFamily: 'Georgia, serif' }}>
